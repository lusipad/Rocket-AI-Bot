...
export function loadConfig(configPath?: string): Config {
  ...
  const merged = {
    ...
    azureDevOpsServer: {
      collectionUrl: process.env.AZURE_DEVOPS_SERVER_COLLECTION_URL || process.env.SYSTEM_TEAMFOUNDATIONCOLLECTIONURI,
      authMode: process.env.AZURE_DEVOPS_SERVER_AUTH_MODE,
      pat: process.env.AZURE_DEVOPS_SERVER_PAT,
      project: process.env.AZURE_DEVOPS_SERVER_PROJECT || process.env.SYSTEM_TEAMPROJECT,
      team: process.env.AZURE_DEVOPS_SERVER_TEAM,
      apiVersion: process.env.AZURE_DEVOPS_SERVER_API_VERSION,
      serverVersionHint: process.env.AZURE_DEVOPS_SERVER_SERVER_VERSION,
      searchBaseUrl: process.env.AZURE_DEVOPS_SERVER_SEARCH_BASE_URL,
      testResultsBaseUrl: process.env.AZURE_DEVOPS_SERVER_TESTRESULTS_BASE_URL,
      scriptPath: process.env.AZURE_DEVOPS_SERVER_SCRIPT_PATH,
      powerShellPath: process.env.AZURE_DEVOPS_SERVER_POWERSHELL_PATH,
      ...(coerced.azureDevOpsServer ?? {}),
    },
    web: {
